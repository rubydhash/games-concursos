...
import br.com.concursos.persistence.ConteudoDao;
import br.com.concursos.persistence.ConteudoDaoXml;

public abstract class JogoTabuleiro implements Jogo {
	 ...
	 */
	public boolean add(int codigo, Quadrante quadrante) throws ConteudoExistenteException, QuadranteInvalidoException, ConteudoExcedeLimitePermitidoException,
